...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("1950197171839652258 a81d9909-dede-4fa9-8f73-ea08e454e7b8 machinepocker-javabot MachinePocker-javaBot".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in machinepocker.javabot package as a set of config entries
        return configLoader.fromResource("machinepocker/javabot/settings");
    }
